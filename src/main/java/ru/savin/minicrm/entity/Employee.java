...
public class Employee {
    ...
    public Employee(String firstName, String lastName, String email, String photo) {
    ...
    public Employee(Long id, String firstName, String lastName, String email, String photo) {
        this.id = id;
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
